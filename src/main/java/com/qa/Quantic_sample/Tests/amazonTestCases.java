...
import com.qa.Quantic_sample.Pages.PostAssertion;
...
public class amazonTestCases extends QuanticUIBase {
    ...
    public void seeMoreFunctionality(JsonObject inputData) {
        JsonElement j = JsonParser.parseString("[\n" +
                "    {\n" +
                "        \"id\": 2560,\n" +
                "        \"name\": \"Gudakesa Desai I\",\n" +
                "        \"email\": \"desai_gudakesa_i@ward.name\",\n" +
                "        \"gender\": \"male\",\n" +
                "        \"status\": \"active\"\n" +
                "    }\n" +
                "]");
        PostAssertion.postAssertion(j, "body.get(0).get(email)#contains#ward");
//        {
//            email:"in [desai_gudakesa_i@ward.name,akash@gmail.com]",
//            email:"contains geminisolution",
//
//        }
        PostAssertion.postAssertion(j, "body.get(0).get(email)#in#[akash,ward]");
